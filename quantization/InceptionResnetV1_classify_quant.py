...
def quantization(title='optimize',
  ...
  model = InceptionResnetV1(pretrained='vggface2', classify=True, num_classes = 17)
  model.load_state_dict(torch.load("./InceptionResnetV1_classify_state_ITR1.pth"))
  model.eval()
  input = torch.randn([batch_size, 3, 166, 166])
